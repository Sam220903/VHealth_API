...
-- 2. CREACIÓN DE TABLAS (Con el ENUM de zonas del cuerpo)
...
INSERT INTO vh_exercises (id, name, description, body_zone, ai_parameters) VALUES 
-- Ejercicio 1: Sentadillas (Rodilla dobla: 180 baja a 100)
(1, 'Sentadillas', 'Ejercicio compuesto para cuádriceps y glúteos. Mantén la espalda recta y baja hasta que tus muslos estén paralelos al suelo.', 'Tren inferior', '{"key_points": [23, 25, 27], "joint": "rodilla", "threshold_start": 150, "threshold_contract": 115, "logic_state": "descending"}'),

-- Ejercicio 2: Desplantes / Zancadas (Rodilla dobla: 180 baja a 100)
(2, 'Desplantes (Zancadas)', 'Da un paso hacia adelante y baja la cadera hasta que ambas rodillas formen un ángulo de 90 grados. Mantén el torso recto.', 'Tren inferior', '{"key_points": [23, 25, 27], "joint": "rodilla", "threshold_start": 160, "threshold_contract": 100, "logic_state": "descending"}'),

-- Ejercicio 3: Elevación de rodilla de pie (Cadera dobla: 180 baja a 110)
(3, 'Elevación de rodilla de pie', 'Levanta una rodilla lo más alto que puedas hacia tu pecho, manteniendo la espalda recta.', 'Tren inferior', '{"key_points": [11, 23, 25], "joint": "cadera", "threshold_start": 160, "threshold_contract": 110, "logic_state": "descending"}'),

-- Ejercicio 4: Elevación frontal de brazos (Hombro se abre: 30 sube a 150)
(4, 'Estiramiento frontal de brazos', 'Eleva ambos brazos extendidos por delante de ti hasta que queden por encima de tu cabeza, y bájalos lentamente.', 'Tren superior', '{"key_points": [23, 11, 13], "joint": "hombro_vertical", "threshold_start": 60, "threshold_contract": 160, "logic_state": "ascending"}'),

-- Ejercicio 5: Elevación lateral de brazos (Hombro se abre hacia afuera: 20 sube a 85)
(5, 'Elevación lateral de brazos', 'Eleva ambos brazos hacia los lados hasta que formen una "T" paralela al piso y bájalos controladamente.', 'Tren superior', '{"key_points": [12, 11, 13], "joint": "hombro_horizontal", "threshold_start": 110, "threshold_contract": 165, "logic_state": "ascending"}');
